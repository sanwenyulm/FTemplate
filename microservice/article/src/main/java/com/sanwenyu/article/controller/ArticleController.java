...
import com.sanwenyu.article.FeignClient.CommentFeignClient;
...
import com.sanwenyu.article.service.ArticleService;
...
public class ArticleController {
	...
	public Result childcomment(@PathVariable("parentid") String parentid, @PathVariable("page")  int page, @PathVariable("size") int size){
	  return commentFeignClient.childcomment(parentid,page,size);
	}
