...
import com.iotyun.manager.modbus4j.sero.io.StreamUtils;
import com.iotyun.manager.modbus4j.sero.log.BaseIOLog;
import com.iotyun.manager.modbus4j.sero.timer.SystemTimeSource;
import com.iotyun.manager.modbus4j.sero.timer.TimeSource;
...
public class MessageControl implements DataConsumer {
     ...
     * <p>start.</p>
     *
     * @param transport a {@link com.iotyun.manager.modbus4j.sero.messaging.Transport} object.
     * @param messageParser a {@link com.iotyun.manager.modbus4j.sero.messaging.MessageParser} object.
     * @param handler a {@link com.iotyun.manager.modbus4j.sero.messaging.RequestHandler} object.
     * @param waitingRoomKeyFactory a {@link com.iotyun.manager.modbus4j.sero.messaging.WaitingRoomKeyFactory} object.
     ...
     *
     * @param exceptionHandler a {@link com.iotyun.manager.modbus4j.sero.messaging.MessagingExceptionHandler} object.
     */
     ...
     *
     * @return a {@link com.iotyun.manager.modbus4j.sero.timer.TimeSource} object.
     */
     ...
     *
     * @param timeSource a {@link com.iotyun.manager.modbus4j.sero.timer.TimeSource} object.
     */
     ...
     * <p>send.</p>
     *
     * @param request a {@link com.iotyun.manager.modbus4j.sero.messaging.OutgoingRequestMessage} object.
     * @return a {@link com.iotyun.manager.modbus4j.sero.messaging.IncomingResponseMessage} object.
     * @throws java.io.IOException if any.
     */
    ...
    public IncomingResponseMessage send(OutgoingRequestMessage request, int timeout, int retries) throws IOException {
        ...
        if (DEBUG){
            ...
            System.out.println("MessagingControl.send: " + StreamUtils.dumpArray(data));
        }
        ...
        if (request.expectsResponse()) {
            ...
            try {
                do {
                    // Send the request.会等timeout 时间去拿返回数据
                    if(write(data,timeout)){
     ...
     * <p>send.</p>
     *
     * @param response a {@link com.iotyun.manager.modbus4j.sero.messaging.OutgoingResponseMessage} object.
     * @throws java.io.IOException if any.
     */
    ...
    private boolean write(byte[] data, int timeout) throws IOException {
        if (ioLog != null)
            ioLog.output(data);
        boolean ret;
        synchronized (transport) {
        	ret = transport.write(data,timeout);
        }
        return ret;
    }
