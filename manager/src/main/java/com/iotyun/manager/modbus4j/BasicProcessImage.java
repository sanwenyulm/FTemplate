...
import com.iotyun.manager.modbus4j.base.RangeAndOffset;
import com.iotyun.manager.modbus4j.code.RegisterRange;
import com.iotyun.manager.modbus4j.exception.IllegalDataAddressException;
...
import com.iotyun.manager.modbus4j.locator.StringLocator;
...
public class BasicProcessImage implements ProcessImage {
     ...
     * <p>addListener.</p>
     *
     * @param l a {@link com.iotyun.manager.modbus4j.ProcessImageListener} object.
     */
     ...
     * @param bit a int.
     * @return a boolean.
     * @throws com.iotyun.manager.modbus4j.exception.IllegalDataAddressException if any.
     */
     ...
     * <p>getRegister.</p>
     *
     * @param locator a {@link com.iotyun.manager.modbus4j.locator.BaseLocator} object.
     * @param <T> a T object.
     * @return a T object.
     * @throws com.iotyun.manager.modbus4j.exception.IllegalDataAddressException if any.
     */
