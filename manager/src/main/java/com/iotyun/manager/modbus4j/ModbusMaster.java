...
import com.iotyun.manager.modbus4j.base.KeyedModbusLocator;
import com.iotyun.manager.modbus4j.base.ReadFunctionGroup;
import com.iotyun.manager.modbus4j.base.SlaveProfile;
import com.iotyun.manager.modbus4j.code.DataType;
import com.iotyun.manager.modbus4j.code.ExceptionCode;
...
import com.iotyun.manager.modbus4j.exception.InvalidDataConversionException;
...
import com.iotyun.manager.modbus4j.locator.BinaryLocator;
import com.iotyun.manager.modbus4j.locator.NumericLocator;
...
import com.iotyun.manager.modbus4j.msg.WriteCoilsRequest;
import com.iotyun.manager.modbus4j.msg.WriteMaskRegisterRequest;
import com.iotyun.manager.modbus4j.msg.WriteRegisterRequest;
import com.iotyun.manager.modbus4j.msg.WriteRegistersRequest;
import com.iotyun.manager.modbus4j.sero.epoll.InputStreamEPollWrapper;
import com.iotyun.manager.modbus4j.sero.log.BaseIOLog;
import com.iotyun.manager.modbus4j.sero.messaging.MessageControl;
import com.iotyun.manager.modbus4j.sero.util.ArrayUtils;
import com.iotyun.manager.modbus4j.sero.util.ProgressiveTask;
...
abstract public class ModbusMaster extends Modbus {
     ...
     * <p>init.</p>
     *
     * @throws com.iotyun.manager.modbus4j.exception.ModbusInitException if any.
     */
     ...
     * <p>send.</p>
     *
     * @param request a {@link com.iotyun.manager.modbus4j.msg.ModbusRequest} object.
     ...
     * @throws com.iotyun.manager.modbus4j.exception.ModbusTransportException
     *             if there was an IO error or other technical failure while sending the message
     * @throws com.iotyun.manager.modbus4j.exception.ErrorResponseException
     ...
     *
     * @param l a {@link com.iotyun.manager.modbus4j.NodeScanListener} object.
     * @return a {@link com.iotyun.manager.modbus4j.sero.util.ProgressiveTask} object.
     */
     ...
     *
     * @return a {@link com.iotyun.manager.modbus4j.sero.log.BaseIOLog} object.
     */
     ...
     *
     * @param ioLog a {@link com.iotyun.manager.modbus4j.sero.log.BaseIOLog} object.
     */
     ...
     *
     * @return a {@link com.iotyun.manager.modbus4j.sero.epoll.InputStreamEPollWrapper} object.
     */
     ...
     *
     * @param ePoll a {@link com.iotyun.manager.modbus4j.sero.epoll.InputStreamEPollWrapper} object.
     */
     ...
     *
     * @param batch a {@link com.iotyun.manager.modbus4j.BatchRead} object.
     * @return a {@link com.iotyun.manager.modbus4j.BatchResults} object.
     * @throws com.iotyun.manager.modbus4j.exception.ModbusTransportException if any.
     * @throws com.iotyun.manager.modbus4j.exception.ErrorResponseException if any.
     ...
     *
     * @return a {@link com.iotyun.manager.modbus4j.sero.messaging.MessageControl} object.
     */
     ...
     *
     * @param conn a {@link com.iotyun.manager.modbus4j.sero.messaging.MessageControl} object.
     */
